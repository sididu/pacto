      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <html class="no-js" lang="en">
            ...
            <head>
               ...
               <!-- Skin -->
               <link href="css/skin-construction.css" rel="stylesheet" type="text/css"/>
               <!-- Favicon -->
            ...
            <body>
               ...
               <!-- Start Navigation -->
               <nav class="navbar navbar-default navbar-fixed dark bootsnav on no-full">
                  <!-- Start Top Search -->
               ...
               <!-- End Navigation -->
               <!-- Banner -->
               <section class="full-height bg white-text header-slide construction-slider single-image overlay" data-overlay-color="dark" data-overlay="5"  data-bg-img="{{ asset('images/pacto/construction/slide1.jpg')}}">
                  <div class="container">
                     <div class="row">
                        <div class="col-md-10 col-md-offset-1 text-center">
                           <h3 class="title">CONSTRUCT YOUR <span class="light-weight">FUTURE</span></h3>
               ...
               <section class="pt-0 top-minus">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="dark-bg pxy-5 sm-px-3 xs-py-5 sm-px-2 xs-py-2 clearfix">
                              <div class="col-md-6 pull-right sm-mb-4"> <img class="img-responsive" src="{{ asset('images/pacto/construction/images1.jpg')}}" alt="" /> </div>
                              <div class="col-md-6">
                                 ...
                                 <div class="row">
                                    <div class="col-xs-4 xs-mb-3">
                                       <div class="counter">
                                          <div class="counter-icon white-text"> <i class="lnr lnr-home icons"></i> </div>
                                          <div class="counter-info"> <span class="timer" data-to="200" data-speed="1000">200</span>
                                             <label>Houses</label>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-xs-4 xs-mb-3">
                                       <div class="counter">
                                          <div class="counter-icon white-text"> <i class="lnr lnr-apartment icons"></i> </div>
                                          <div class="counter-info"> <span class="timer" data-to="87" data-speed="1000">87</span>
                                    ...
                                    <div class="col-xs-4">
                                       <div class="counter">
                                          <div class="counter-icon white-text"> <i class="lnr lnr-store icons"></i> </div>
                                          <div class="counter-info"> <span class="timer" data-to="50" data-speed="1000">50</span>
                                             <label>Stores</label>
                                          </div>
                                       </div>
                                    </div>
               ...
               <section class="p-0 feature-section feature-construction">
                  <div class="container-fluid">
                     <div class="row no-gutter row-eq-height">
                        <!-- Icon Position Left  -->
                        <div class="col-md-4 py-6 px-5 sm-py-3 sm-px-3" data-bg-color="#ffd71f" >
                           <div class="feature icon-position-left">
                              <div class="feature-icon"> <i class="lnr lnr-apartment"></i> </div>
                              <div class="feature-info">
                                 <h4 class="solid-weight">New Construction</h4>
                                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                    tempor incididunt ut labore et dolore magna aliqua ut enim
                                 </p>
                                 <a href="#" class="btn btn-default btn-outline dark-border dark-text btn-radius btn-xs fill-dark mt-2">learn more</a> 
                              </div>
                           </div>
                        </div>
                        <div class="col-md-4 py-6 px-5 theme-bg sm-py-3 sm-px-3">
                           <div class="feature icon-position-left">
                              <div class="feature-icon"> <i class="lnr lnr-home icons"></i> </div>
                              <div class="feature-info">
                                 <h4 class="solid-weight">Renovation</h4>
                                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                    tempor incididunt ut labore et dolore magna aliqua ut enim
                                 </p>
                                 <a href="#" class="btn btn-default btn-outline dark-border dark-text btn-radius btn-xs fill-dark mt-2">learn more</a> 
                        ...
                        <div class="col-md-4 py-6 px-5 sm-py-3 sm-px-3" data-bg-color="#ffc600">
                           <div class="feature icon-position-left">
                              <div class="feature-icon"> <i class="lnr  lnr-construction"></i> </div>
                              <div class="feature-info">
                                 <h4 class="solid-weight">Architectural Design</h4>
                                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                    tempor incididunt ut labore et dolore magna aliqua ut enim
                                 </p>
                                 <a href="#" class="btn btn-default btn-outline dark-border dark-text btn-radius btn-xs fill-dark mt-2">learn more</a> 
               ...
               <!-- End Feature -->
               <!-- About -->
               <section class="pos-r"  data-bg-img="{{ asset('images/pacto/construction/bg2.jpg')}}">
                  <img src="{{ asset('images/pacto/construction/image2.png')}}" class="right-img visible-md visible-lg" alt="" />
                  <div class="container">
                     <div class="row">
                        <div class="col-md-7">
                           <div class="heading-block">
                              <span class="text-uppercase theme-text solid-weight">ABOUT CONSTRUCTION</span>
                              <h3>WE ARE PROFESSIONAL CONSTRUCTION COMPANY SINCE 1985.</h3>
                           </div>
                           <p class="lead">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
                           <p>Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit. Prepare to meet the one and only WordPress theme perfect for both corporate and creative projects. Ronneby has everything you need to launch your site within next few days or even hours!</p>
                           <div class="row">
                              <div class="col-xs-4 col-xx-12 text-center xs-mb-4">
                                 <div class="rounded-skill nobottommargin" data-color="#ffd200" data-size="120" data-percent="75" data-width="3" data-speed="6500">
                                    <div class="counter counter-inherit"> <span class="timer" data-from="1" data-to="75" data-refresh-interval="50" data-speed="3000"></span>% </div>
                                 </div>
                                 <h4 class="title">Creative</h4>
                              </div>
                              <div class="col-xs-4 col-xx-12 text-center xs-mb-4">
                                 <div class="rounded-skill nobottommargin" data-color="#ffd200" data-size="120" data-percent="90" data-width="3" data-speed="6500">
                                    <div class="counter counter-inherit"> <span class="timer" data-from="1" data-to="90" data-refresh-interval="50" data-speed="3000"></span>% </div>
                                 </div>
                                 <h4 class="title">Management</h4>
                              </div>
                              <div class="col-xs-4 col-xx-12 text-center">
                                 <div class="rounded-skill nobottommargin" data-color="#ffd200" data-size="120" data-percent="50" data-width="3" data-speed="6500">
                                    <div class="counter counter-inherit"> <span class="timer" data-from="1" data-to="50" data-refresh-interval="50" data-speed="3000"></span>% </div>
                                 </div>
               ...
               <!-- End About -->
               <!-- Our Team -->
               <section class="dark-bg overlay bg fixed" data-overlay-color="dark" data-overlay="9" data-bg-img="{{ asset('images/pacto/construction/slide1.jpg')}}" >
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-12 mb-3">
                           <div class="heading-block text-center">
                              <span class="text-uppercase theme-text solid-weight">Our Team</span>
                     ...
                     <div class="col-sm-12">
                        ...
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('images/pacto/construction/member1.jpg')}}" alt="" /></div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('images/pacto/construction/member2.jpg')}}" alt="" /></div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('images/pacto/construction/member3.jpg')}}" alt="" /></div>
                              <div class="team-info">
                        ...
                        <div class="item">
                           <div class="team">
                              <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('images/pacto/construction/member4.jpg')}}" alt="" /></div>
                              <div class="team-info">
               ...
               <!-- End Our Team -->
               <!-- Why us -->
               <section class="p-0 pos-r why-us-construction">
                  <div class="container-fluid">
                     <div class="row grey-bg row-eq-height">
                        <div class="col-sm-6 col-lg-5 pos-r">
                           <div class="pxy-5 text-right xs-px-0 xs-py-5">
                              <div class="heading-block text-right">
                                 <span class="text-uppercase solid-weight theme-text">WHY US?</span>
                                 <h3 class="solid-weight">WE ARE EXPERIENCED PROFESSIONAL COMPANY. WE BUILD CREATIVE & PROFESSIONAL </h3>
                              </div>
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim</p>
                              <a href="#" class="btn btn-default btn-sm btn-radius btn-outline fill-dark">learn more</a> 
                           </div>
                        </div>
                        <div class="col-lg-3 bg visible-lg" data-bg-img="{{ asset('images/pacto/construction/images2.jpg')}}"> </div>
                        <div class="col-sm-6 col-lg-4  theme-bg">
                           <div class="pxy-5 feature-section xs-px-3 xs-pb-2">
                              <div class="feature  icon-position-left">
                                 <div class="feature-icon"> <i class="lnr lnr-thumbs-up theme-text"></i> </div>
                                 <div class="feature-info">
                                    <h4 class="solid-weight">WE ARE RESPONSIBLE</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                                 </div>
                              </div>
                              <div class="feature icon-position-left mt-2">
                                 <div class="feature-icon"> <i class="lnr lnr-map theme-text"></i> </div>
                                 <div class="feature-info">
                                    <h4 class="solid-weight">DISCOVER & PLAN</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                                 </div>
                              </div>
                              <div class="row mt-2">
                        ...
                        <div class="col-xs-12">
                           <div class="b-isotope b-isotope-1">
                              <ul class="b-isotope-grid grid list-unstyled">
                                 ...
                                 <li class="grid-item construction digging renovation">
                                    <div class="py-2 pr-5">
                                       <div class="heading-block">
                                          <span class="text-uppercase theme-text solid-weight">Our Projects</span>
                                          <h3>We are creating Your dream</h3>
                                       </div>
                                 ...
                                 <li class="grid-item construction">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img1.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img1.jpg')}}" alt="Photo" /> 
                                       </div>
                                 ...
                                 <li class="grid-item digging">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img2.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img2.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                                 ...
                                 <li class="grid-item renovation">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img3.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img3.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                                 ...
                                 <li class="grid-item construction">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img4.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img4.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                                 ...
                                 <li class="grid-item renovation">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img8.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img8.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                                 ...
                                 <li class="grid-item digging">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img4.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img5.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                                 ...
                                 <li class="grid-item construction">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img6.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img6.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                                 ...
                                 <li class="grid-item digging">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img7.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img7.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                                 ...
                                 <li class="grid-item renovation">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img9.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img9.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
                                 ...
                                 <li class="grid-item digging">
                                    <div class="isotope-img portfolio-item">
                                       <div class="item-img">
                                          <div class="overlay"> <a class="link-icon popup-img" title="Project" href="{{ asset('images/pacto/construction/portfolio/img10.jpg')}}"><i class="lnr lnr-picture"></i></a> <a class="link-icon" href="#"><i class="lnr lnr-link"></i></a> </div>
                                          <img src="{{ asset('images/pacto/construction/portfolio/img10.jpg')}}" alt="Photo" /> 
                                       </div>
                                       <div class="image-info">
                                          <h3 class="name"><a href="#">Lorem ipsum dolor sit amet</a></h3>
                                          <a class="link-icon" href="#">Sed do eiusmod tempor</a> 
