    ...
    <!--[if IE 8]>         
      ...
      <!--[if gt IE 8]><!--> 
        ...
        <body>
          ...
          <!-- End Navigation -->
          <!-- Banner -->
          <section class="inner-intro dark-bg bg bg-fixed overlay jarallax" data-jarallax='{"speed": 0.2}' data-overlay-color="dark" data-overlay="2" data-bg-img="{{ asset('images/pacto/banner.jpg')}}" >
            <div class="container">
              <div class="row intro-title text-center">
                <div class="col-sm-12">
                  <h1 class="title text-white text-uppercase">About Company</h1>
                </div>
                <div class="col-sm-12">
                  <ul class="page-breadcrumb">
                    <li><a href="{{ url('/')}}">Home</a></li>
                    <li><a href="about-1">Pages</a></li>
                    <li><span class="theme-text">About Company</span> </li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="row mb-3">
                <div class="col-sm-6">
                  <div class="heading-block">
                    ...
                    <h2 class="text-uppercase solid-weight">Why Choose Us</h2>
                    <div class="divider"></div>
                  </div>
                  <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim
                  </p>
                ...
                <div class="col-sm-6 ">
                  <div class="video-info">
                    <img class="img-responsive center-block" src="{{ asset('images/pacto/corporate/image2.jpg')}}" alt="">
                    <a class="popup-vimeo video-btn theme-bg" href="{{ asset('video/video.mp4')}}"><i class="icon-control-play icons"></i></a>
                  </div>
                </div>
              </div>
              <!-- Technology -->
                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-sm-4 mb-3">
                      <div class="feature">
                        <div class="feature-icon">
                          <i class="lnr lnr-keyboard theme-text"></i>
                        </div>
                        <div class="feature-info">
                          <h5 class="solid-weight">Technology</h5>
                    ...
                    <div class="col-sm-4 mb-3">
                      <div class="feature">
                        <div class="feature-icon">
                          <i class="lnr lnr-user theme-text"></i>
                        </div>
                        <div class="feature-info">
                          <h5 class="solid-weight">People</h5>
                          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-4 mb-3">
                      <div class="feature">
                        <div class="feature-icon">
                          <i class="lnr lnr-users theme-text"></i>
                        </div>
                        <div class="feature-info">
                          <h5 class="solid-weight">Resources</h5>
                          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the.</p>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-8 col-sm-offset-4 col-md-offset-6">
                  <div class="py-7 pl-7 xs-py-4 sm-py-5 sm-pl-7 xs-pl-0">
                    <div class="heading-block">
                      <span class="text-uppercase light-weight">Tempor incididunt labore dolore veniam</span>
                      <h2 class="text-uppercase solid-weight">Company Milestone</h2>
                      <div class="divider"></div>
                    </div>
                    ...
                    <div class="timeline timeline-3 clearfix mt-4">
                      ...
                      <div class="timeline-panel">
                        <label class="year theme-bg">2013</label>
                        <div class="timeline-body">
                      ...
                      <div class="timeline-panel">
                        <label class="year theme-bg">2016</label>
                        <div class="timeline-body">
                ...
                <div class="col-md-6 col-sm-8">
                  <div class="py-7 pr-7 xs-py-3 xs-pr-0">
                    <div class="heading-block">
                      ...
                      <h2 class="text-uppercase solid-weight">Our Mission</h2>
                      <div class="divider"></div>
                    </div>
                    <p >Nullam felis sapien, commodo ac posuere non, pretium nec mauris. Ut nibh velit, accumsan at dapibus quis, venenatis ac turpis.</p>
          ...
          <!-- Our Mission -->
          <!-- service -->
          <section class="theme-bg pb-7 sm-pb-4">
            <div class="container">
              <div class="row">
                <div class="col-sm-4 mb-3">
                  ...
                  <div class="owl-carousel owl-theme light-arrow" data-items="3" data-md-items="3" data-sm-items="3" data-xs-items="2" data-nav-dots="false" data-nav-arrow="false" data-auto-play="true"  data-space="0">
                    <div class="item">
                      <div class="team">
                        <div class="member-image clearfix">
                          ...
                          <img class="img-responsive" src="{{ asset('images/pacto/team/member2.jpg')}}" alt="" />
                        </div>
                        <div class="team-info">
                    ...
                    <div class="item">
                      <div class="team">
                        <div class="member-image clearfix">
                          <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a>
                          <img class="img-responsive" src="{{ asset('images/pacto/team/member3.jpg')}}" alt="" />
                        </div>
                        <div class="team-info">
                    ...
                    <div class="item">
                      <div class="team">
                        <div class="member-image clearfix">
                          <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a>
                          <img class="img-responsive" src="{{ asset('images/pacto/team/member4.jpg')}}" alt="" />
                        </div>
                        <div class="team-info">
          ...
          <!-- jquery  -->
          <script type="text/javascript" rc="{{ asset('templates/pacto/js/jquery.min.js')}}"></script>
          <!-- Bootstrap -->
