      ...
      <html class="no-js lt-ie9" lang="">
         ...
         <html class="no-js" lang="en">
            ...
            <body>
               ...
               <!-- End Navigation -->
         <!-- Banner -->  
         <section class="full-height bg white-text header-slide gym-slider single-image" data-bg-img="{{ asset('images/pacto/gym/slide2.jpg')}}">
            <div class="container">
               <div class="row">
         ...
         <section class="p-0 gym-rules">
            <div class="container-fluid">
               <div class="row row-eq-height no-gutter">
                  ...
                  <div class="col-md-4 dark-bg overlay" data-bg-img="{{ asset('images/pacto/gym/carousel-item2.jpg')}}" data-overlay-color="dark" data-overlay="7">
                     <div class="py-5 px-5 sm-px-4 sm-py-4">
         ...
         <!-- End Opening Time -->
         <!-- about us -->
         <section class="bg gym-about" data-bg-img="{{ asset('images/pacto/gym/girl-fit_bg.jpg')}}">
            <div class="container">
                        ...
                        <div class="row no-gutter">
                           <div class="col-sm-4 col-xs-6 col-xx-12">
                              <div class="team classes">
                                 <div class="member-image clearfix"> <img class="img-responsive" src="{{ asset('images/pacto/gym/classes-img1.jpg')}}" alt="" /></div>
                                 <div class="team-info">
                           ...
                           <div class="col-sm-4 col-xs-6 col-xx-12">
                              <div class="team classes">
                                 <div class="member-image clearfix"> <img class="img-responsive" src="{{ asset('images/pacto/gym/classes-img2.jpg')}}" alt="" /></div>
                                 <div class="team-info">
                           ...
                           <div class="col-sm-4 col-xs-6 col-xx-12">
                              <div class="team classes">
                                 <div class="member-image clearfix"> <img class="img-responsive" src="{{ asset('images/pacto/gym/classes-img3.jpg')}}" alt="" /></div>
                                 <div class="team-info">
                           ...
                           <div class="col-sm-4 col-xs-6 col-xx-12">
                              <div class="team classes">
                                 <div class="member-image clearfix"> <img class="img-responsive" src="{{ asset('images/pacto/gym/classes-img4.jpg')}}" alt="" /></div>
                                 <div class="team-info">
                           ...
                           <div class="col-sm-4 col-xs-6 col-xx-12">
                              <div class="team classes">
                                 <div class="member-image clearfix"> <img class="img-responsive" src="{{ asset('images/pacto/gym/classes-img5.jpg')}}" alt="" /></div>
                                 <div class="team-info">
                           ...
                           <div class="col-sm-4 col-xs-6 col-xx-12">
                              <div class="team classes">
                                 <div class="member-image clearfix"> <img class="img-responsive" src="{{ asset('images/pacto/gym/classes-img6.jpg')}}" alt="" /></div>
                                 <div class="team-info">
               ...
               <div class="row">
                  ...
                  <div class="item">
                     <div class="team team-4">
                        <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('images/pacto/gym/member5.jpg')}}" alt="" /></div>
                  ...
                  <div class="item">
                     <div class="team team-4">
                        <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('images/pacto/gym/member2.jpg')}}" alt="" /></div>
                        <div class="team-info theme-bg">
                  ...
                  <div class="item">
                     <div class="team team-4">
                        <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('images/pacto/gym/member3.jpg')}}" alt="" /></div>
                        <div class="team-info theme-bg">
                  ...
                  <div class="item">
                     <div class="team team-4">
                        <div class="member-image clearfix"> <a class="arrow-btn" href="#"><i class="lnr lnr-arrow-right"></i></a> <img class="img-responsive" src="{{ asset('images/pacto/gym/member4.jpg')}}" alt="" /></div>
                        <div class="team-info theme-bg">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-6 pull-right sm-mb-4">
                     <div class="video-info"> <img class="img-responsive" src="{{ asset('images/pacto/gym/video-bg.jpg')}}" alt=""> <a class="popup-vimeo video-btn theme-bg" href={{ asset('video/video.mp4')}}"><i class="icon-control-play icons"></i></a> </div>
                  </div>
                  <div class="col-md-6">
                     <div class="heading-block ">
               ...
               <div class="row no-gutter">
                  <div class="col-sm-12">
                     <div class="owl-carousel popup-gallery" data-items="4" data-md-items="3" data-sm-items="2" data-xs-items="2" data-space="0">
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item1.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item1.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item2.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item2.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item3.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item3.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item4.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item4.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item5.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item5.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item6.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item6.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item7.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item7.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item8.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item8.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item9.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item9.jpg')}}" alt=""></a></div>
                        <div class="item"><a class="popup-img" href="{{ asset('images/pacto/gym/carousel-item10.jpg')}}"><img class="img-responsive" src="{{ asset('images/pacto/gym/carousel-item10.jpg')}}" alt=""></a></div>
                     </div>
                  </div>
               </div>
            </div>
